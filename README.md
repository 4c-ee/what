...
To simply summarize the manpage into a much simpler usage guide rather than going into the verbose specifics like `man` does.
...
**I one-shotted this with Gemini. I did not make this, Gemini did.**
